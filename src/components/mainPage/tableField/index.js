...
import { ActOfDiscrepanciesProducts, InvoiceProducts, Invoices, Organizations, Subgroups, Warehouses, Contracts, ActOfDiscrepancies, Costs} from "../../referencesTables";
    ...
    <div className="position">
      {
        ...
        checkIdes(0, 1, 5) ? <Costs state={state}/> :
        (
        <>
